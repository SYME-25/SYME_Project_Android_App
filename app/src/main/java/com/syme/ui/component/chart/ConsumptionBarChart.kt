...
fun ConsumptionInjectionBarChart(
    ...
    Row(
        ...
        ChartLegendItem(color = Accent500, label = stringResource(R.string.consumption_label))
        ChartLegendItem(color = Brand900, label = stringResource(R.string.consumption_type_subscription))
        ChartLegendItem(color = SemanticWarning500, label = stringResource(R.string.consumption_injection))
    }
}
